...
| 7   | `bot/build-search`     | `buildSearch`                                                                                                   | BuildSearch.ts (2,000-node fast-forward search, ~0.7 ms); `scripts/lab/valuefit.py` (since deleted with buildSearch) — on 395 games the fitted predictor beats rank-at-t at 5/8/10/15 min (ρ 0.56–0.68 vs 0.51–0.65).                                                                                                                                           |
